...
class MalGAN():
    ...
    def __init__(self, blackbox='RF', same_train_data=1, filename='mydata.npz', apifeature_dims=160):
    ...
    def build_blackbox_detector(self):
        ...
        if self.blackbox is 'RF':
            blackbox_detector = RandomForestClassifier(n_estimators=100, max_depth=10, random_state=1)
